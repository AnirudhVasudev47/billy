...
class ThemeColors {
  ...
  //Text
  static Color headLineText1Light = Color(0xff181818);
  static Color headLineText2Light = Color(0xff181818);
  static Color bodyText1Light = Color(0xff181818);
  ...
  //Text
  static Color headLineText1Dark = Color(0xff181818);
  static Color headLineText2Dark = Color(0xff181818);
  static Color bodyText1Dark = Color(0xff181818);
  static Color bodyText2Dark = Color(0xff181818);
}
